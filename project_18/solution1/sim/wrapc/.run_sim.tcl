...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "integer_alu.autotvin.dat"
	set constFileTvOut       "integer_alu.autotvout.dat"
	set constFileHdlTvIn     "integer_alu.autohdltvin.dat"
	set constFileHdlTvOut    "integer_alu.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
