...
#define WRAPC_STREAM_SIZE_IN_in1 "../tv/stream_size/stream_size_in_in1.dat"
#define WRAPC_STREAM_INGRESS_STATUS_in1 "../tv/stream_size/stream_ingress_status_in1.dat"
#define AUTOTB_TVIN_in2 "../tv/cdatafile/c.integer_alu.autotvin_in2.dat"
#define WRAPC_STREAM_SIZE_IN_in2 "../tv/stream_size/stream_size_in_in2.dat"
#define WRAPC_STREAM_INGRESS_STATUS_in2 "../tv/stream_size/stream_ingress_status_in2.dat"
#define AUTOTB_TVIN_op "../tv/cdatafile/c.integer_alu.autotvin_op.dat"
#define WRAPC_STREAM_SIZE_IN_op "../tv/stream_size/stream_size_in_op.dat"
#define WRAPC_STREAM_INGRESS_STATUS_op "../tv/stream_size/stream_ingress_status_op.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.integer_alu.autotvout_out_r.dat"
...
extern "C"
void integer_alu_hw_stub_wrapper(void*, void*, void*, void*);

extern "C"
void apatb_integer_alu_hw(void* __xlx_apatb_param_in1, void* __xlx_apatb_param_in2, void* __xlx_apatb_param_op, void* __xlx_apatb_param_out_r)
{
  static hls::sim::Stream<hls::sim::Byte<1>> port0 {
    .width = 8,
    .name = "in1",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_in1),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_in1),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_in1),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_in1),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_in1;
  ...
  static hls::sim::Stream<hls::sim::Byte<1>> port1 {
    ...
    .name = "in2",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_in2),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_in2),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_in2),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_in2),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_in2;
  ...
  static hls::sim::Stream<hls::sim::Byte<1>> port2 {
    ...
    .name = "op",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_op),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_op),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_op),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_op),
#endif
  };
  port2.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_op;
  ...
  port3.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_out_r;
  port3.hasWrite = true;
  ...
  try {
    ...
    integer_alu_hw_stub_wrapper(__xlx_apatb_param_in1, __xlx_apatb_param_in2, __xlx_apatb_param_op, __xlx_apatb_param_out_r);
    port3.buffer();
