...
if {[file isfile integer_alu.autotvin.dat]} {
	file delete -force integer_alu.autotvin.dat
}

if {[file isfile integer_alu.autotvout.dat]} {
	file delete -force integer_alu.autotvout.dat
}
