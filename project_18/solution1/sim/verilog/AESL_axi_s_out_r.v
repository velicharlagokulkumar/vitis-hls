...
`define TV_OUT_out_r_TDATA "../tv/rtldatafile/rtl.integer_alu.autotvout_out_r.dat"
...
module AESL_axi_s_out_r (
    ...
    reg [16 - 1:0] out_r_TDATA_write_data;
    reg out_r_TDATA_read_en;
    wire [16 - 1:0] out_r_TDATA_read_data;
    
    fifo #(1, 16) fifo_out_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
