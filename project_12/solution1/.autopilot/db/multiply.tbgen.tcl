...
set C_modelArgList {
	{ A int 28 regular {fifo 0 volatile }  }
	{ B int 28 regular {fifo 0 volatile }  }
	{ C int 56 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "fifo", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "B", "interface" : "fifo", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "C", "interface" : "fifo", "bitwidth" : 56, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "A_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "A", "role": "dout" }} , 
 	...
 	{ "name": "B_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "B", "role": "dout" }} , 
 	...
 	{ "name": "C_din", "direction": "out", "datatype": "sc_lv", "bitwidth":56, "type": "signal", "bundle":{"name": "C", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_28s_28s_56_1_1_U1", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	A { ap_fifo {  { A_dout fifo_port_we 0 28 }  { A_empty_n fifo_status 0 1 }  { A_read fifo_data 1 1 } } }
	B { ap_fifo {  { B_dout fifo_port_we 0 28 }  { B_empty_n fifo_status 0 1 }  { B_read fifo_data 1 1 } } }
	C { ap_fifo {  { C_din fifo_port_we 1 56 }  { C_full_n fifo_status 0 1 }  { C_write fifo_data 1 1 } } }
}
