...
#define WRAPC_STREAM_SIZE_IN_B "../tv/stream_size/stream_size_in_B.dat"
#define WRAPC_STREAM_INGRESS_STATUS_B "../tv/stream_size/stream_ingress_status_B.dat"
...
extern "C"
void multiply_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_multiply_hw(void* __xlx_apatb_param_A, void* __xlx_apatb_param_B, void* __xlx_apatb_param_C)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_A;
  ...
  static hls::sim::Stream<hls::sim::Byte<4>> port1 {
    ...
    .name = "B",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_B),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_B),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_B),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_B),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_B;
  ...
  port2.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_C;
  port2.hasWrite = true;
  ...
  try {
    ...
    multiply_hw_stub_wrapper(__xlx_apatb_param_A, __xlx_apatb_param_B, __xlx_apatb_param_C);
    port2.buffer();
