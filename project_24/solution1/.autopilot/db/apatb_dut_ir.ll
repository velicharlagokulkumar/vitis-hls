; ModuleID = 'C:/Users/velic/AppData/Roaming/Xilinx/Vitis/project_24/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_dut_ir(%"class.hls::stream<ap_uint<8>, 0>"* noalias nocapture nonnull dereferenceable(1) %in_stream, %"class.hls::stream<ap_uint<32>, 0>"* noalias nocapture nonnull dereferenceable(4) %out_stream) local_unnamed_addr #1 {
entry:
  %in_stream_copy = alloca %"class.hls::stream<ap_uint<8>, 0>", align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(%"class.hls::stream<ap_uint<8>, 0>"* %in_stream_copy, i32 0) ]
  %out_stream_copy = alloca %"class.hls::stream<ap_uint<32>, 0>", align 512
  call void @llvm.sideeffect() #8 [ "stream_interface"(%"class.hls::stream<ap_uint<32>, 0>"* %out_stream_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<ap_uint<8>, 0>"* nonnull %in_stream, %"class.hls::stream<ap_uint<8>, 0>"* nonnull align 512 %in_stream_copy, %"class.hls::stream<ap_uint<32>, 0>"* nonnull %out_stream, %"class.hls::stream<ap_uint<32>, 0>"* nonnull align 512 %out_stream_copy)
  call void @apatb_dut_hw(%"class.hls::stream<ap_uint<8>, 0>"* %in_stream_copy, %"class.hls::stream<ap_uint<32>, 0>"* %out_stream_copy)
  call void @copy_back(%"class.hls::stream<ap_uint<8>, 0>"* %in_stream, %"class.hls::stream<ap_uint<8>, 0>"* %in_stream_copy, %"class.hls::stream<ap_uint<32>, 0>"* %out_stream, %"class.hls::stream<ap_uint<32>, 0>"* %out_stream_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<ap_uint<8>, 0>"* noalias, %"class.hls::stream<ap_uint<8>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<32>, 0>"* noalias, %"class.hls::stream<ap_uint<32>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<ap_uint<8>, 0>"* noalias, %"class.hls::stream<ap_uint<8>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<32>, 0>"* noalias, %"class.hls::stream<ap_uint<32>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
declare void @apatb_dut_hw(%"class.hls::stream<ap_uint<8>, 0>"*, %"class.hls::stream<ap_uint<32>, 0>"*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<ap_uint<8>, 0>"* noalias, %"class.hls::stream<ap_uint<8>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", %"class.hls::stream<ap_uint<32>, 0>"* noalias, %"class.hls::stream<ap_uint<32>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<8>, 0>"(%"class.hls::stream<ap_uint<8>, 0>"* %0, %"class.hls::stream<ap_uint<8>, 0>"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<32>, 0>"(%"class.hls::stream<ap_uint<32>, 0>"* %2, %"class.hls::stream<ap_uint<32>, 0>"* align 512 %3)
  ret void
...
define void @dut_hw_stub_wrapper(%"class.hls::stream<ap_uint<8>, 0>"*, %"class.hls::stream<ap_uint<32>, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<ap_uint<8>, 0>"* null, %"class.hls::stream<ap_uint<8>, 0>"* %0, %"class.hls::stream<ap_uint<32>, 0>"* null, %"class.hls::stream<ap_uint<32>, 0>"* %1)
  call void @dut_hw_stub(%"class.hls::stream<ap_uint<8>, 0>"* %0, %"class.hls::stream<ap_uint<32>, 0>"* %1)
  call void @copy_in(%"class.hls::stream<ap_uint<8>, 0>"* null, %"class.hls::stream<ap_uint<8>, 0>"* %0, %"class.hls::stream<ap_uint<32>, 0>"* null, %"class.hls::stream<ap_uint<32>, 0>"* %1)
  ret void
}

declare void @dut_hw_stub(%"class.hls::stream<ap_uint<8>, 0>"*, %"class.hls::stream<ap_uint<32>, 0>"*)
