...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "multiplier.autotvin.dat"
	set constFileTvOut       "multiplier.autotvout.dat"
	set constFileHdlTvIn     "multiplier.autohdltvin.dat"
	set constFileHdlTvOut    "multiplier.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
