...
if {[file isfile multiplier.autotvin.dat]} {
	file delete -force multiplier.autotvin.dat
}

if {[file isfile multiplier.autotvout.dat]} {
	file delete -force multiplier.autotvout.dat
}
