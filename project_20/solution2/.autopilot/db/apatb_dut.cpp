...
#define AUTOTB_TVOUT_start_index "../tv/cdatafile/c.dut.autotvout_start_index.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.dut.autotvout_output_r.dat"
...
extern "C"
void dut_hw_stub_wrapper(hls::sim::Byte<1>*, void*);

extern "C"
void apatb_dut_hw(hls::sim::Byte<1>* __xlx_apatb_param_start_index, void* __xlx_apatb_param_output_r)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_start_index),
#endif
  };
  port0.param = __xlx_apatb_param_start_index;
  ...
  try {
    ...
    dut_hw_stub_wrapper(__xlx_apatb_param_start_index, __xlx_apatb_param_output_r);
    port1.buffer();
