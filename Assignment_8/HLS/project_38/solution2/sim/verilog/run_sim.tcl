...
if {[file isfile cyclic_prefix_removal.autotvin.dat]} {
	file delete -force cyclic_prefix_removal.autotvin.dat
}

if {[file isfile cyclic_prefix_removal.autotvout.dat]} {
	file delete -force cyclic_prefix_removal.autotvout.dat
}
