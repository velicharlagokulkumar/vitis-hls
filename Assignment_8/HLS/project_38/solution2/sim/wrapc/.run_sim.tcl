...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cyclic_prefix_removal.autotvin.dat"
	set constFileTvOut       "cyclic_prefix_removal.autotvout.dat"
	set constFileHdlTvIn     "cyclic_prefix_removal.autohdltvin.dat"
	set constFileHdlTvOut    "cyclic_prefix_removal.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
