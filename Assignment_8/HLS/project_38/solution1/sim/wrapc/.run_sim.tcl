...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "data_generator.autotvin.dat"
	set constFileTvOut       "data_generator.autotvout.dat"
	set constFileHdlTvIn     "data_generator.autohdltvin.dat"
	set constFileHdlTvOut    "data_generator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
