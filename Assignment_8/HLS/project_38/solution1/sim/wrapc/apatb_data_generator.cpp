...
#define WRAPC_STREAM_SIZE_OUT_gout "../tv/stream_size/stream_size_out_gout.dat"
#define WRAPC_STREAM_EGRESS_STATUS_gout "../tv/stream_size/stream_egress_status_gout.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gout "../tv/rtldatafile/rtl.data_generator.autotvout_gout.dat"
...
extern "C"
void data_generator_hw_stub_wrapper(void*);

extern "C"
void apatb_data_generator_hw(void* __xlx_apatb_param_gout)
{
  static hls::sim::Stream<hls::sim::Byte<8>> port0 {
    .width = 64,
    .name = "gout",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_gout),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_gout),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_gout),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_gout),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_gout;
  port0.hasWrite = true;
  ...
  try {
    ...
    data_generator_hw_stub_wrapper(__xlx_apatb_param_gout);
    port0.buffer();
