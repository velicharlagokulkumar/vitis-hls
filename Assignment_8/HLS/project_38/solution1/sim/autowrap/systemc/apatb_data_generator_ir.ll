; ModuleID = 'C:/Users/velic/OneDrive/Desktop/project_38/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_data_generator_ir(%"class.hls::stream<ComplexT, 0>"* noalias nocapture nonnull dereferenceable(8) %gout) local_unnamed_addr #1 {
entry:
  %gout_copy = alloca %"class.hls::stream<ComplexT, 0>", align 512
  call void @llvm.sideeffect() #7 [ "stream_interface"(%"class.hls::stream<ComplexT, 0>"* %gout_copy, i32 0) ]
  call fastcc void @copy_in(%"class.hls::stream<ComplexT, 0>"* nonnull %gout, %"class.hls::stream<ComplexT, 0>"* nonnull align 512 %gout_copy)
  call void @apatb_data_generator_hw(%"class.hls::stream<ComplexT, 0>"* %gout_copy)
  call void @copy_back(%"class.hls::stream<ComplexT, 0>"* %gout, %"class.hls::stream<ComplexT, 0>"* %gout_copy)
  ret void
}
...
declare void @apatb_data_generator_hw(%"class.hls::stream<ComplexT, 0>"*)
...
define void @data_generator_hw_stub_wrapper(%"class.hls::stream<ComplexT, 0>"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream<ComplexT, 0>"* null, %"class.hls::stream<ComplexT, 0>"* %0)
  call void @data_generator_hw_stub(%"class.hls::stream<ComplexT, 0>"* %0)
  call void @copy_in(%"class.hls::stream<ComplexT, 0>"* null, %"class.hls::stream<ComplexT, 0>"* %0)
  ret void
}

declare void @data_generator_hw_stub(%"class.hls::stream<ComplexT, 0>"*)
