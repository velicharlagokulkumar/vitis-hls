...
if {[file isfile data_generator.autotvin.dat]} {
	file delete -force data_generator.autotvin.dat
}

if {[file isfile data_generator.autotvout.dat]} {
	file delete -force data_generator.autotvout.dat
}
