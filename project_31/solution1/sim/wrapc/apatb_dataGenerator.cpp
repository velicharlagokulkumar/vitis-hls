...
// wrapc file define:
#define AUTOTB_TVOUT_outputStream "../tv/cdatafile/c.dataGenerator.autotvout_outputStream.dat"
#define WRAPC_STREAM_SIZE_OUT_outputStream "../tv/stream_size/stream_size_out_outputStream.dat"
#define WRAPC_STREAM_EGRESS_STATUS_outputStream "../tv/stream_size/stream_egress_status_outputStream.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_outputStream "../tv/rtldatafile/rtl.dataGenerator.autotvout_outputStream.dat"
...
extern "C"
void dataGenerator_hw_stub_wrapper(void*);

extern "C"
void apatb_dataGenerator_hw(void* __xlx_apatb_param_outputStream)
{
  static hls::sim::Stream<hls::sim::Byte<8>> port0 {
    .width = 64,
    .name = "outputStream",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_outputStream),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_outputStream),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_outputStream),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_outputStream),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_outputStream;
  port0.hasWrite = true;
  ...
  try {
    ...
    dataGenerator_hw_stub_wrapper(__xlx_apatb_param_outputStream);
    port0.buffer();
