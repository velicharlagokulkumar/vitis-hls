...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dataGenerator.autotvin.dat"
	set constFileTvOut       "dataGenerator.autotvout.dat"
	set constFileHdlTvIn     "dataGenerator.autohdltvin.dat"
	set constFileHdlTvOut    "dataGenerator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
