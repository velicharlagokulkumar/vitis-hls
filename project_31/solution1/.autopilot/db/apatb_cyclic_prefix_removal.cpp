...
#define AUTOTB_TVOUT_in_samples "../tv/cdatafile/c.cyclic_prefix_removal.autotvout_in_samples.dat"
#define AUTOTB_TVIN_out_samples "../tv/cdatafile/c.cyclic_prefix_removal.autotvin_out_samples.dat"
...
extern "C"
void cyclic_prefix_removal_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_cyclic_prefix_removal_hw(void* __xlx_apatb_param_in_samples, void* __xlx_apatb_param_out_samples)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_in_samples),
#endif
  };
  port0.param = __xlx_apatb_param_in_samples;
  port0.depth = 8800;
...
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_out_samples),
    .iwriter = nullptr,
#endif
  };
  port1.param = __xlx_apatb_param_out_samples;
  port1.depth = 8192;
  port1.hasWrite = true;
  ...
  try {
    ...
    cyclic_prefix_removal_hw_stub_wrapper(__xlx_apatb_param_in_samples, __xlx_apatb_param_out_samples);
