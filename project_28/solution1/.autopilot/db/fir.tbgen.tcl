...
set C_modelArgList {
	{ y int 48 regular {pointer 1}  }
	{ c int 24 regular {array 4 { 1 3 } 1 1 }  }
	{ x int 24 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "y", "interface" : "wire", "bitwidth" : 48, "direction" : "WRITEONLY"} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 24, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ y sc_out sc_lv 48 signal 0 } 
	{ y_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ c_address0 sc_out sc_lv 2 signal 1 } 
	{ c_ce0 sc_out sc_logic 1 signal 1 } 
	{ c_q0 sc_in sc_lv 24 signal 1 } 
	{ x sc_in sc_lv 24 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "y", "direction": "out", "datatype": "sc_lv", "bitwidth":48, "type": "signal", "bundle":{"name": "y", "role": "default" }} , 
 	...
 	{ "name": "c_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "c", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_24s_24s_48_1_1_U1", "Parent" : "0"},
...
set Spec2ImplPortList { 
	y { ap_vld {  { y out_data 1 48 }  { y_ap_vld out_vld 1 1 } } }
	c { ap_memory {  { c_address0 mem_address 1 2 }  { c_ce0 mem_ce 1 1 }  { c_q0 mem_dout 0 24 } } }
