...
(* CORE_GENERATION_INFO="multiply_multiply,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=6.912000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=168,HLS_SYN_LUT=85,HLS_VERSION=2022_2}" *)
...
wire   [63:0] C_TDATA_int_regslice;
...
assign C_TDATA_int_regslice = $signed(grp_fu_53_p2);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((regslice_both_C_U_apdone_blk == 1'b1) | (1'b0 == C_TREADY_int_regslice))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == C_TREADY_int_regslice)) | ((1'b1 == 1'b1) & ((1'b0 == B_TVALID_int_regslice) | (1'b0 == A_TVALID_int_regslice))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((regslice_both_C_U_apdone_blk == 1'b1) | (1'b0 == C_TREADY_int_regslice))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == C_TREADY_int_regslice)) | ((1'b1 == 1'b1) & ((1'b0 == B_TVALID_int_regslice) | (1'b0 == A_TVALID_int_regslice))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & ((regslice_both_C_U_apdone_blk == 1'b1) | (1'b0 == C_TREADY_int_regslice))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == C_TREADY_int_regslice)) | ((1'b1 == 1'b1) & ((1'b0 == B_TVALID_int_regslice) | (1'b0 == A_TVALID_int_regslice))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (1'b0 == C_TREADY_int_regslice);
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((regslice_both_C_U_apdone_blk == 1'b1) | (1'b0 == C_TREADY_int_regslice));
end
