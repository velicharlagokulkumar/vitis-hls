...
set name multiply_mul_32s_32s_32_2_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { C_TDATA { O 64 vector } C_TVALID { O 1 bit } C_TREADY { I 1 bit } } \
} "
} else {
...
# RegSlice definition:
set ID 6
set RegSliceName multiply_regslice_both
set RegSliceInstName multiply_regslice_both_U
set CoreName ap_simcore_multiply_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
