...
set portList { 
	...
	{ C_TDATA sc_out sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "C_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "C", "role": "TDATA" }} , 
...
set Spec2ImplPortList { 
	...
	C { axis {  { C_TDATA out_data 1 64 }  { C_TVALID out_vld 1 1 }  { C_TREADY out_acc 0 1 } } }
}
