...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "zadoff_chu_generator_hls.autotvin.dat"
	set constFileTvOut       "zadoff_chu_generator_hls.autotvout.dat"
	set constFileHdlTvIn     "zadoff_chu_generator_hls.autohdltvin.dat"
	set constFileHdlTvOut    "zadoff_chu_generator_hls.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
