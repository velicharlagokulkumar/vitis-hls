...
if {[file isfile zadoff_chu_generator_hls.autotvin.dat]} {
	file delete -force zadoff_chu_generator_hls.autotvin.dat
}

if {[file isfile zadoff_chu_generator_hls.autotvout.dat]} {
	file delete -force zadoff_chu_generator_hls.autotvout.dat
}
