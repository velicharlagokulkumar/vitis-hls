...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.zadoff_chu_generator_hls.autotvin_length_r.dat"
         "c.zadoff_chu_generator_hls.autotvin_u.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.zadoff_chu_generator_hls.autotvout_out_stream.dat"
         "rtl.zadoff_chu_generator_hls.autotvout_tlast.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
