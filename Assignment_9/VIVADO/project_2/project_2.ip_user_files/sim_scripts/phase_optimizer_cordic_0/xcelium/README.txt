...
#
# Generated by export_simulation on Mon Jul 10 15:01:38 +0530 2023
#
################################################################################
...
'-reset_run' switch to the './phase_optimizer_cordic_0.sh' script.

./phase_optimizer_cordic_0.sh -reset_run
...
./phase_optimizer_cordic_0.sh -noclean_files

For more information on the script, please type './phase_optimizer_cordic_0.sh -help'.
