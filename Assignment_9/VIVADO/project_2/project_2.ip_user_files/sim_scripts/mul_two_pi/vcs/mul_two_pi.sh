...
#
# Generated by Vivado on Mon Jul 10 02:41:23 +0530 2023
# SW Build 3671981 on Fri Oct 14 05:00:03 MDT 2022
#
# Tool Version Limit: 2022.10 
#
# usage: mul_two_pi.sh [-help]
# usage: mul_two_pi.sh [-lib_map_path]
# usage: mul_two_pi.sh [-noclean_files]
# usage: mul_two_pi.sh [-reset_run]
#
...
# executing this script. Please type 'mul_two_pi.sh -help' for more information.
#
...
# Script info
echo -e "mul_two_pi.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../project_2.gen/sources_1/ip/mul_two_pi/sim/mul_two_pi.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mul_two_pi xil_defaultlib.glbl -o mul_two_pi_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mul_two_pi_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./mul_two_pi.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key mul_two_pi_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc mul_two_pi_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./mul_two_pi.sh -help\" for more information)\n"
    exit 1
  fi
