...
#
# Generated by Vivado on Mon Jul 10 11:09:46 +0530 2023
# SW Build 3671981 on Fri Oct 14 05:00:03 MDT 2022
#
# Tool Version Limit: 2022.10 
#
# usage: fix_float_int.sh [-help]
# usage: fix_float_int.sh [-lib_map_path]
# usage: fix_float_int.sh [-noclean_files]
# usage: fix_float_int.sh [-reset_run]
#
...
# executing this script. Please type 'fix_float_int.sh -help' for more information.
#
...
# Script info
echo -e "fix_float_int.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../project_2.gen/sources_1/ip/fix_float_int/sim/fix_float_int.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fix_float_int xil_defaultlib.glbl -o fix_float_int_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fix_float_int_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fix_float_int.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fix_float_int_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fix_float_int_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fix_float_int.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: fix_float_int.sh [-help]\n\
Usage: fix_float_int.sh [-lib_map_path]\n\
Usage: fix_float_int.sh [-reset_run]\n\
Usage: fix_float_int.sh [-noclean_files]\n\n\
