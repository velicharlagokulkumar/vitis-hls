...
# Design libraries
design_libs=(simprims_ver xlconstant_v1_1_7 xil_defaultlib xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 floating_point_v7_1_15)
...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/design_1/ipshared/2be0/hdl/verilog" \
       +incdir+"../../../../project_1.gen/sources_1/bd/design_1/ipshared/2be0/hdl/verilog" \
       -input simulate.do
}
