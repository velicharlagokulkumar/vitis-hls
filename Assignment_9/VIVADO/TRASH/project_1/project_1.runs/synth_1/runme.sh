...
HD_PWD='C:/Users/velic/OneDrive/Desktop/vitis-hls/Assignment_9/VIVADO/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zadoff_chu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zadoff_chu.tcl
