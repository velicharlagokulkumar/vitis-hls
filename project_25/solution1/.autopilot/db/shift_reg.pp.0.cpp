# 1 "../../../../OneDrive/Desktop/vitis/shift_reg.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../../../OneDrive/Desktop/vitis/shift_reg.cpp" 2
...
# 2 "../../../../OneDrive/Desktop/vitis/shift_reg.cpp" 2
...
# 3 "../../../../OneDrive/Desktop/vitis/shift_reg.cpp" 2
typedef ap_uint<16> size;
__attribute__((sdx_kernel("shift_register", 0))) void shift_register(hls::stream<size> &data_in, size shift_value, bool shift_flag,
                    hls::stream<size> &data_out) {
#line 16 "C:/Users/velic/AppData/Roaming/Xilinx/Vitis/project_25/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=shift_register
# 5 "../../../../OneDrive/Desktop/vitis/shift_reg.cpp"

#line 7 "C:/Users/velic/AppData/Roaming/Xilinx/Vitis/project_25/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=shift_register
# 5 "../../../../OneDrive/Desktop/vitis/shift_reg.cpp"
...
#pragma HLS UNROLL
 din[i]=data_in.read();
    ...
    if (shift_flag) {
           VITIS_LOOP_19_2: for (int i = 0; i < 16; i++) {
...
#pragma HLS UNROLL
 int shift_index = i - shift_value;
           ...
           VITIS_LOOP_30_3: for (int i = 0; i < 16; i++) {
...
#pragma HLS UNROLL
 int shift_index = i + shift_value;
   ...
   VITIS_LOOP_42_4: for (int i = 0; i < 16; i++) {
#pragma HLS UNROLL
