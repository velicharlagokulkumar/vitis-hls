...
`define TV_OUT_data_out_TDATA "../tv/rtldatafile/rtl.shift_register.autotvout_data_out.dat"
...
module AESL_axi_s_data_out (
    input clk,
    input reset,
    input [16 - 1:0] TRAN_data_out_TDATA,
    ...
    reg [16 - 1:0] data_out_TDATA_write_data;
    reg data_out_TDATA_read_en;
    wire [16 - 1:0] data_out_TDATA_read_data;
    
    fifo #(16, 16) fifo_data_out_TDATA (
        .reset(1'b0),
        .write_clock(clk),
