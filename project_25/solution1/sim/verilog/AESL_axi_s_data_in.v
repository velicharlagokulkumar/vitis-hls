...
`define TV_IN_data_in_TDATA "../tv/cdatafile/c.shift_register.autotvin_data_in.dat"
...
module AESL_axi_s_data_in (
    input clk,
    input reset,
    output [16 - 1:0] TRAN_data_in_TDATA,
    ...
    reg [16 - 1:0] data_in_TDATA_write_data;
    reg data_in_TDATA_read_en;
    wire [16 - 1:0] data_in_TDATA_read_data;
    
    fifo #(16, 16) fifo_data_in_TDATA (
        .reset(1'b0),
        .write_clock(clk),
