...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.shift_register.autotvin_data_in.dat"
         "c.shift_register.autotvin_shift_value.dat"
         "c.shift_register.autotvin_shift_flag.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.shift_register.autotvout_data_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
