...
#define AUTOTB_TVOUT_shift_value "../tv/cdatafile/c.shift_register.autotvout_shift_value.dat"
#define AUTOTB_TVIN_shift_flag "../tv/cdatafile/c.shift_register.autotvin_shift_flag.dat"
#define AUTOTB_TVOUT_shift_flag "../tv/cdatafile/c.shift_register.autotvout_shift_flag.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_data_out "../tv/rtldatafile/rtl.shift_register.autotvout_data_out.dat"
...
extern "C"
void shift_register_hw_stub_wrapper(void*, hls::sim::Byte<2>*, hls::sim::Byte<1>, void*);

extern "C"
void apatb_shift_register_hw(void* __xlx_apatb_param_data_in, hls::sim::Byte<2>* __xlx_apatb_param_shift_value, hls::sim::Byte<1> __xlx_apatb_param_shift_flag, void* __xlx_apatb_param_data_out)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_data_in;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_shift_value),
#endif
  };
  port1.param = __xlx_apatb_param_shift_value;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_shift_flag),
#endif
  };
  port2.param = &__xlx_apatb_param_shift_flag;
  ...
  port3.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_data_out;
  port3.hasWrite = true;
  ...
  try {
    ...
    shift_register_hw_stub_wrapper(__xlx_apatb_param_data_in, __xlx_apatb_param_shift_value, __xlx_apatb_param_shift_flag, __xlx_apatb_param_data_out);
    port3.buffer();
